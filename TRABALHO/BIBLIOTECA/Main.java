...
public class Main{
    ...
    public static void main(String[] args) {
        ...
        biblioteca.addGerente(new Gerente("Brayan", "brayanalvesdossantos67@gmail.com", "senha123", "45999849552", "15842056950"));
        ...
        if(entrada == 1){
            ...
            if (biblioteca.getClientes().get(indexLogin-1).getLivrosEmPosse().isEmpty()) {
                ...
                for (Livro livro : biblioteca.getClientes().get(indexLogin-1).getLivrosEmPosse()) {
                    System.out.printf("Livro: %s\nAutor: %s\nEditora: %s\n", livro.getNome(), livro.getAutor(), livro.getEditora());
                }
            }
        }else if(entrada == 4){
            return;
